...
#username = 'devdatalab'
#tileset_name = 'rural-data-portal'
#
#
###########################
...
print("ERROR: upload the tileset manually to mapbox studio - this gets around API fees, which are steep.")
print(f"file is located here: {args.file}")
